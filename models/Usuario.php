...
class Usuario extends ActiveRecord {
  ...
  public function validarLogin() {
    ...
    if(!$this->password) {
      self::$alertas["error"][] = "Debes escribir tu contraseña para acceder";
    }
  ...
  public function validarPassword() {
    ...
    if(strlen($this->password) < 6) {
      self::$alertas["error"][] = "El password debe tener por lo menos 6 caracteres";
    }
  ...
  public function existeUsuario() {
    ...
    if($resultado->num_rows) {
      self::$alertas["error"][] = "El usuario ya ha sido registrado";
    }
